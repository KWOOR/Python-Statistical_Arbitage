...
#    for j in range(100):
#        buy_open+=((buy_open+sell_open)==0)*(buy_open.shift(1)==1) * (pd.DataFrame(X_t > 0.01*X_t.std()))*1
#        sell_open+=((buy_open+sell_open)==0)*(sell_open.shift(1)==-1) * pd.DataFrame(X_t < -0.01*X_t.std())*-1  
#    for j in range(100):        
